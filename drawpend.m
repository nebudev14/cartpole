% Animates the cart pole given physical constants and a set of states at
% time t. Credit to Steve Brunton's Control Bootcamp https://github.com/bertozzijr/Control_Bootcamp_S_Brunton/tree/master
